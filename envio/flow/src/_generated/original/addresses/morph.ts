export const chainId = 2818;
export const chain = "morph";
export const startBlock_lockup = 45000;
export const startBlock_merkle = 45000;
export const startBlock_flow = 980000;

export const hypersync = "https://morph.hypersync.xyz/";
...
export const merged: string[][] = [["0xf3cd08105b6745965149ef02b8abdcea0ae51241", "LK", "V23"]];
