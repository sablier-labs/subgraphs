...
export const startBlock_lockup = 44637120;
export const startBlock_merkle = 51245830;
export const startBlock_flow = 65079000;
...
export const tranched: string[][] = [["0xbf67f0a1e847564d0efad475782236d3fa7e9ec2", "LT3", "V22"]];

export const merged: string[][] = [["0xe0bfe071da104e571298f8b6e0fce44c512c1ff4", "LK", "V23"]];
