...
export const startBlock_lockup = 4067889;
export const startBlock_merkle = 4904890;
export const startBlock_flow = 6618000;
export const startBlock_merger = 7292400;
...
export const tranched: string[][] = [["0x3a1bea13a8c24c0ea2b8fae91e4b2762a59d7af5", "LT3", "V22"]];

export const merged: string[][] = [["0xd116c275541cdbe7594a202bd6ae4dbca4578462", "LK", "V23"]];
