...
export const startBlock_lockup = 28766600;
export const startBlock_merkle = 31491790;
export const startBlock_flow = 37356000;
...
export const tranched: string[][] = [["0x59a4b7255a5d01247837600e7828a6f77f664b34", "LT3", "V22"]];

export const merged: string[][] = [["0x007af5dc7b1caa66cf7ebcc01e2e6ba4d55d3e92", "LK", "V23"]];
