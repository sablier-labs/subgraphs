...
export const startBlock_lockup = 106405050;
export const startBlock_merkle = 113621900;
export const startBlock_flow = 128865000;
...
export const tranched: string[][] = [["0x90952912a50079bef00d5f49c975058d6573acdc", "LT3", "V22"]];

export const merged: string[][] = [["0x822e9c4852e978104d82f0f785bfa663c2b700c1", "LK", "V23"]];

export const flow: string[][] = [
  ["0x906356e4e6410ea0a97dbc5b071cf394ab0dcd69", "FL", "V10"],
  ["0xc5612fea2d370127ac67048115bd6b1df7b7f7c0", "FL2", "V11"],
];
...
export const factory: string[][] = [
  ...
  ["0x2455bff7a71e6e441b2d0b1b1e480fe36ebf6d1e", "MSF4", "V23"],
];
