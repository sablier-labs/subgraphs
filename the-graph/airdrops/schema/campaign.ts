...
import { ADDRESS_ZERO, ONE, ZERO } from "../../shared/constants";
...
function createCampaign(id: string, event: ethereum.Event): EntityCampaign | null {
  ...
  if (entity != null) {
    log.error("Campaign already registered at this address", []);
    return null;
  }
  ...
  if (factory == null) {
    log.error("Factory not yet registered at this address", []);
    return null;
  }
