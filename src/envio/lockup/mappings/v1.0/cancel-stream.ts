...
Contract.LockupDynamic_v1_0.CancelLockupStream.handlerWithLoader(handlerWithLoader);
Contract.LockupLinear_v1_0.CancelLockupStream.handlerWithLoader(handlerWithLoader);
